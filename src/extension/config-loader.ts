 ...
 */
export function withWorkflowDefaults(config: WorkflowExtensionConfig): WorkflowEffectiveConfig {
	return {
		maxDepth: config.maxDepth ?? WORKFLOW_CONFIG_DEFAULTS.maxDepth,
		defaultConcurrency: config.defaultConcurrency ?? WORKFLOW_CONFIG_DEFAULTS.defaultConcurrency,
 ...
 */
export async function loadWorkflowConfig(opts: LoadWorkflowConfigOpts = {}): Promise<ConfigLoadResult> {

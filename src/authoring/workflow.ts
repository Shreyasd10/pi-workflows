...
>(definition: object): WorkflowDefinition<TInputs, TOutputs, TRunInputs> {
...
>(spec: AuthoredWorkflowSpec<TInputs, TOutputs, TActualOutputs>): AuthoredWorkflowDefinition<TInputs, TOutputs> {
	...
	if (
		...
		(spec.inputs === null || typeof spec.inputs !== "object" || Array.isArray(spec.inputs))
	) {
